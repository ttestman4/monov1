...
# cd ..
# git clone https://github.com/ttestman4/monov1.git
# cd spav6withlib
# git checkout -b develop
# cd ..
# foo/node_modules/.bin/ng --version
# foo/node_modules/.bin/ng new --help
# foo/node_modules/.bin/ng new spa --directory monov1 -g --routing --skip-install --style scss --view-encapsulation None -g -v -d
# cd monov1
# yarn
